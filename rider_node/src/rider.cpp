...
using robotis::rider::Rider;
using namespace std::chrono_literals;

Rider::Rider(const std::string & usb_port)
: Node("rider_node", rclcpp::NodeOptions().use_intra_process_comms(true))
{
  RCLCPP_INFO(get_logger(), "Init Rider Node Main");
...
Rider::Wheels * Rider::get_wheels()
{
  return &wheels_;
}

Rider::Motors * Rider::get_motors()
{
  return &motors_;
}

void Rider::init_dynamixel_sdk_wrapper(const std::string & usb_port)
{
...
void Rider::check_device_status()
{
...
void Rider::publish_timer(const std::chrono::milliseconds timeout)
{
...
void Rider::heartbeat_timer(const std::chrono::milliseconds timeout)
{
...
void Rider::parameter_event_callback()
{
